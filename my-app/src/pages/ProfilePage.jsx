                    ...
                    <div className={styles.profilePageContainer}>
                        ...
                        <div className={`${styles.profileHeaderCard} ${styles.card}`}>
                            ...
                            <div className={styles.headerActions}>
                                {!isEditing && (
                                    <button className={styles.primaryBtn} onClick={handleEdit}>Edit Profile</button>
                                )}
                                {isEditing && (
                                    <>
                        ...
                        <div className={styles.profileGrid}>
                                ...
                                <div className={styles.profileForm}>
                                    <div className={styles.formRow}>
                                        <div className={styles.formGroup}>
                                            ...
                                            <input type="text" value={personalInfo.firstName} disabled={!isEditing}
                                                onChange={e => handlePersonalChange('firstName', e.target.value)} />
                                        </div>
                                        <div className={styles.formGroup}>
                                            <label>Last Name</label>
                                            <input type="text" value={personalInfo.lastName} disabled={!isEditing}
                                    ...
                                    <div className={styles.formRow}>
                                        <div className={styles.formGroup}>
                                            ...
                                            <input type="email" value={personalInfo.email} disabled={!isEditing}
                                                onChange={e => handlePersonalChange('email', e.target.value)} />
                                        </div>
                                        <div className={styles.formGroup}>
                                            <label>Phone Number</label>
                                            <input type="tel" value={personalInfo.phone} disabled={!isEditing}
                                    ...
                                    <div className={styles.formRow}>
                                        <div className={styles.formGroup}>
                                            ...
                                            <input type="date" value={personalInfo.dob} disabled={!isEditing}
                                                onChange={e => handlePersonalChange('dob', e.target.value)} />
                                        </div>
                                        <div className={styles.formGroup}>
                                            <label>Gender</label>
                                            <select value={personalInfo.gender} disabled={!isEditing}
                                ...
                                <div className={styles.profileForm}>
                                    <div className={styles.formRow}>
                                        <div className={styles.formGroup}>
                                            ...
                                            <input type="number" value={physicalInfo.currentWeight} disabled={!isEditing}
                                                onChange={e => handlePhysicalChange('currentWeight', e.target.value)} />
                                        </div>
                                        <div className={styles.formGroup}>
                                            <label>Target Weight (kg)</label>
                                            <input type="number" value={physicalInfo.targetWeight} disabled={!isEditing}
                                                onChange={e => handlePhysicalChange('targetWeight', e.target.value)} />
                                        </div>
                                    </div>
                                    <div className={styles.formRow}>
                                        <div className={styles.formGroup}>
                                            <label>Height (cm)</label>
                                            <input type="number" value={physicalInfo.height} disabled={!isEditing}
                                                onChange={e => handlePhysicalChange('height', e.target.value)} />
                                        </div>
                                        <div className={styles.formGroup}>
                                            <label>Activity Level</label>
                                            <select value={physicalInfo.activityLevel} disabled={!isEditing}
                                                onChange={e => handlePhysicalChange('activityLevel', e.target.value)}>
                                    ...
                                    <div className={styles.formRow}>
                                        <div className={`${styles.formGroup} ${styles.fullWidth}`}>
                                            ...
                                            <select value={physicalInfo.primaryGoal} disabled={!isEditing}
                                                onChange={e => handlePhysicalChange('primaryGoal', e.target.value)}>
                            ...
                            <div className={`${styles.card} ${styles.preferencesCard}`}>
                                ...
                                <div className={styles.preferenceList}>
                                    {[
                                        { key: 'emailNotifications', title: 'Email Notifications', desc: 'Receive daily summaries and goal updates.' },
                                        { key: 'smsReminders', title: 'SMS Reminders', desc: 'Get text reminders for scheduled workouts.' },
                                        { key: 'publicProfile', title: 'Public Profile', desc: 'Allow other users to view your achievements and progress.' },
                                    ].map(pref => (
