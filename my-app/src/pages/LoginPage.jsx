...
function LoginPage() {
    ...
    const handlePasswordBlur = () => {
        if (password.trim() === '') { setPasswordStatus(null); return; }
        setPasswordStatus(passwordPolicy(password));
    };

    const handlePasswordChange = (val) => {
        setPassword(val);
        if (passwordStatus === false) setPasswordStatus(passwordPolicy(val) || null);
    };
            ...
            <div className={styles.splitWrapper}>
                ...
                <div className={styles.visualSide}>
                    ...
                    <div className={styles.visualContent}>
                        <h2>Welcome Back</h2>
                        <p>Pick up where you left off. Continue your journey towards a healthier, stronger you.</p>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} noValidate>
                            ...
                            <div className={getGroupClass(passwordStatus)}>
                                ...
                                <span className={styles.errorText}>
                                    Password must be at least 10 chars, include uppercase, lowercase, number, and special char.
                                </span>
