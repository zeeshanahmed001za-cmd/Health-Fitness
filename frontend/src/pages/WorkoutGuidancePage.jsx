      ...
      <div className={pageStyles.contentInner}>
        <section className={pageStyles.guidanceHero}>
          <div className={pageStyles.heroContent}>
            ...
            <p>
              Science-backed tips to maximize your performance, prevent
              injury, and see results faster.
            </p>
          </div>
        </section>
        ...
        <div className={pageStyles.guidanceGrid}>
          ...
          <article className={pageStyles.guidanceCard}>
            <div className={`${pageStyles.cardIcon} ${pageStyles.gold}`}>
              <StarIcon />
            </div>
            <h3>Core Training Principles</h3>
            <ul>
              <li>
                <strong>Progressive Overload:</strong> Gradually increase
                weight or reps every week to keep muscles growing.
              </li>
              <li>
                <strong>Form Over Weight:</strong> Never sacrifice technique
                for heavier loads. Bad form leads to injuries.
              </li>
              <li>
                <strong>Consistency:</strong> Showing up is 80% of the battle.
                Stick to your split!
              </li>
            </ul>
          </article>
          ...
          {/* Stretching */}
          <article className={pageStyles.guidanceCard}>
            <div className={`${pageStyles.cardIcon} ${pageStyles.cyan}`}>
              <WaterIcon />
            </div>
            ...
            <div className={pageStyles.subSection}>
              ...
              <p>
                Focus on movement: Arm circles, leg swings, cat-cow. Goal is
            ...
            <div className={pageStyles.subSection}>
              ...
              <p>
                Focus on holding: Hamstring stretch, chest opener. Hold for
                30-45s to aid recovery.
              </p>
            </div>
          </article>
          ...
          {/* Breathing */}
          <article className={pageStyles.guidanceCard}>
            <div className={`${pageStyles.cardIcon} ${pageStyles.purple}`}>
              <BrainIcon />
            </div>
            <h3>Breathing & Bracing</h3>
            <p>
              Breath is the foundation of power. Use the{" "}
              <strong>Valsalva Maneuver</strong> for heavy lifts:
            </p>
            <ol>
              <li>Inhale deeply into your belly.</li>
              <li>
                Exert force (the "push") while holding breath or exhaling
                slowly.
              </li>
          ...
          {/* Rest */}
          <article className={pageStyles.guidanceCard}>
            <div className={`${pageStyles.cardIcon} ${pageStyles.green}`}>
              <CalendarIcon />
            </div>
            ...
            <ul>
              <li>
                <strong>Sleep:</strong> Aim for 7-9 hours of quality rest.
              </li>
              <li>
                <strong>Rest Days:</strong> At least 1-2 days of active
                recovery per week.
              </li>
              <li>
                <strong>Hydration:</strong> Drink 3-4 liters of water daily.
              </li>
            </ul>
          </article>
        </div>
        ...
        <section className={pageStyles.splitIntensitySection}>
          <div className={pageStyles.guidanceGrid}>
            {/* Splits */}
            <article className={pageStyles.guidanceCard}>
              <div className={`${pageStyles.cardIcon} ${pageStyles.blue}`}>
                <DumbbellIcon />
              </div>
              ...
              <div className={pageStyles.splitItem}>
                ...
                <p>
                  3-6 days/week. Focuses on movement patterns. Best for muscle
                  growth.
                </p>
              </div>
              <div className={pageStyles.splitItem}>
                ...
                <p>
                  4 days/week. Balances frequency and recovery. Great for
              ...
              <div className={pageStyles.splitItem}>
                <h4>Full Body</h4>
                <p>
                  3 days/week. Hits every muscle group in every session.
            ...
            {/* Intensity */}
            <article className={pageStyles.guidanceCard}>
              <div className={`${pageStyles.cardIcon} ${pageStyles.red}`}>
                <BoltIcon />
              </div>
              ...
              <div className={pageStyles.splitItem}>
                <h4>Beginner</h4>
                <p>
                  Focus: Learning form. RPE 6-7 (Leaving 3-4 reps in the
                  tank). 2-3 sets per exercise.
                </p>
              </div>
              <div className={pageStyles.splitItem}>
                <h4>Intermediate</h4>
                <p>
                  Focus: Hypertrophy. RPE 8-9 (Leaving 1-2 reps in the tank).
              ...
              <div className={pageStyles.splitItem}>
                <h4>Advanced</h4>
                <p>
                  Focus: Power & Detail. RPE 9.5-10 (Training to failure).
                  Advanced techniques like drop sets.
                </p>
              </div>
            </article>
          </div>
